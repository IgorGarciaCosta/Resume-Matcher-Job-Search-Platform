        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    ResumeFileName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    JobSource = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false),
                    Score = table.Column<int>(type: "integer", nullable: false),
                    MatchingKeywordsJson = table.Column<string>(type: "text", nullable: false),
                    MissingKeywordsJson = table.Column<string>(type: "text", nullable: false),
                    ImprovementSuggestions = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavedAnalyses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
